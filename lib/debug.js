...
var _Named = require("./mixins/Named");

var _Named2 = _interopRequireDefault(_Named);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = function (_, f) {
	return f(_dcl2.default, _advise2.default, _Named2.default);
	...
	function logCtor(ctr) {
		var meta = ctr[dcl.meta];
		if (!meta) {
			return console.log('class doesn\'t have information compatible with dcl');
		}
		console.log('class "' + ctr.name + '" is based on "' + (meta.base ? meta.base.name : 'null') + '" with ' + meta.mixins.length + ' mixin' + (meta.mixins.length == 1 ? '' : 's'));
