...
(['module', 'heya-unit', '../dcl'], function (module, unit, dcl) {
	...
	unit.add(module, [
		function test_si (t) {
			...
			const B = dcl(A, Base => class extends Base {static get [dcl.declaredClass] () { return 'B'; }});
			const C = dcl(B, Base => class extends Base {static get [dcl.declaredClass] () { return 'C'; }});
